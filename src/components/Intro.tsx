...
import { motion, MotionProps, MotionStyle, Transition, useTransform, useViewportScroll } from 'framer-motion'
    ...
    >
      ...
      >
        <motion.span className='block absolute top-0 left-0 h-full w-1/2 text-green overflow-hidden'>
          <motion.span {...leftProps} className="absolute pb-[0.1em] top-1/2 -translate-y-1/2 right-[-3.5em] whitespace-nowrap">Mitchell &amp; Natalie</motion.span>
        </motion.span>
        <motion.span className='block absolute top-0 left-1/2 h-full w-1/2 text-blue overflow-hidden'>
          <motion.span {...rightProps} className="absolute pb-[0.1em] top-1/2 -translate-y-1/2 left-[-3.81em] whitespace-nowrap">Mitchell &amp; Natalie</motion.span>
        </motion.span>
      </motion.h1>
    </motion.div>
}
